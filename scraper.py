...
if __name__ == "__main__":
    ...
    search_tasks = [
        "clinical knowledge support healthcare professionals", 
        "virtual assistant for clinical rehabilitation",
        "cross-border digital healthcare interoperability"
    ]
    ...
    if all_collected_papers:
        output_filename = 'hybrede_metadata_v3.json'
